    ...
    <div className="aboutUsContainer bg-green-300 pt-[3.2rem] xsm:pt-[3.6rem] ">
      <div className="aboutUsWrapper bg-fuchsia-500 py-4 xsm:py-5 sm:py-6 md:py-8 px-3 w-[99%] xsm:w-[96%] lg:w-[90%] m-auto  ">
        ...
        <h1 className=" bg-blue-400 mb-2 robotoFont text-sm xsm:text-base ">
          ...
          customers and a steadfast commitment to their motto, 'Customers Come
          First,' Gadget Hunter has risen to prominence as the preferred choice
        ...
        <h1 className=" bg-green-400 mb-2 robotoFont text-sm xsm:text-base ">
          ...
          located in six central regions across Dhaka, Gazipur, Chattogram,
          Khulna, Rajshahi, and Rangpur. The company maintains a total of 17
          physical outlets nationwide, specializing in the sale of authentic
          tech products. Among these outlets, nine are situated in Dhaka, the
          capital city, while Gadget Hunter also maintains two branches in
          Chittagong, the commercial hub of Bangladesh. Additionally, one branch
        ...
        <h1 className=" bg-amber-400 mb-6 robotoFont text-sm xsm:text-base ">
          ...
          We take immense satisfaction in seeing our customers happy and
          content, driven by our unwavering commitment to providing them with
          their desired products. Customer satisfaction is our top priority, and
          we meticulously track their preferences, striving to bring their
          wishes to life. Additionally, we offer a convenient delivery service,
          enabling customers to effortlessly order online and have their desired
        ...
        <h1 className=" bg-amber-400 mb-6  robotoFont text-sm xsm:text-base ">
          ...
          is checked and reviewed before it is sold to our Loyal Customers. You
          are our driving force to better ourselves in all aspects of the
        ...
        <h1 className=" bg-amber-400 mb-6 robotoFont text-sm xsm:text-base ">
          ...
          customer's wishes. Our commitment to continuous improvement fuels our
          aspiration to provide everyone with their desired or dream products.
          We've embraced the digital age by offering convenient online shopping
          opportunities and nationwide delivery services across Bangladesh. Our
          dedication extends beyond the purchase, as we take pride in delivering
          top-notch post-purchase customer service, ensuring that our customers
          feel valued and well-supported, with effective solutions to their
          concerns.
        </h1>
        ...
        <h1 className=" bg-amber-400  robotoFont text-sm xsm:text-base ">
          ...
          our company's values. Gadget Hunter ensures that our customers receive
          the finest service and the most attractive deals. We prioritize our
          customers' wishes and needs, striving to consistently deliver
          exceptional results to our devoted clientele. Our after-sales support
          guarantees that none of our customers face the same issue twice. We
          invite you to explore the services, products, and amenities offered by
          Gadget Hunter and experience a level of excellence like no other.
        </h1>
